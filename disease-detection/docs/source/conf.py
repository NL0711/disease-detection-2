...
# disease_detection documentation build
...
from disease_detection import __version__ as release

# -- Project information -----------------------------------------------------

project = "disease_detection"
author = "Kedro"
...
htmlhelp_basename = "disease_detectiondoc"
...
latex_documents = [
    (
        master_doc,
        "disease_detection.tex",
        "disease_detection Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "disease_detection",
        "Project disease_detection codebase.",
        "Data-Science",
    )
]
